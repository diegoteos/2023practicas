<?php
include_once 'add/encabezado.html';
?>
	...
	<div class="prt_about_wrapperd">
				...
				<div class="row">
					<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
						<div class="prt_about_img">
							...
							<img src="img/foto.jpg" width: 100%; height: auto; alt="About">
						</div>
					</div>
					<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
		...
		<div class="prt_footer_wrapper  ">
			<div class="container">
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<!-- <p>Copyright © 2023 <a href="#">Portfolio</a>. All Rights Reserved</p> -->
						<p>Copyright © 2023 <a href="index.html">Inicio</a>. Todos los derechos reservados</p>
						<ul>
