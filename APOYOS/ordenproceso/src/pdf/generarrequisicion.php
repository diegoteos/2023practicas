...
$pdf->Cell(20, 5, $result_venta['id_requisicion'], 0, 1, 'L');
...
$pdf->MultiCell(190, 5, utf8_decode ($result_venta['fecharequisicion']));
$pdf->SetFont('Arial', 'B', 10); 
...
$pdf->SetFont('Arial', '', 10);
$pdf->Cell(40, 5, $result_venta['tiempoentregarequisicion'], 0, 0, 'L');
$pdf->SetFont('Arial', 'B', 10); 
...
$pdf->SetFont('Arial', '', 10);
$pdf->Cell(20, 5,utf8_decode ($result_venta['personaqueautoriza']), 0, 1, 'L');
$pdf->SetFont('Arial', 'B', 10);
...
$pdf->SetFont('Arial', '', 10);
$pdf->Cell(50, 5,utf8_decode ($result_venta['numerorequisicion']), 0, 0, 'L');
$pdf->SetFont('Arial', 'B', 10);
$pdf->SetFont('Arial', 'B', 10); 
