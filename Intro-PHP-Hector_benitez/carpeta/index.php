...
<body>
  <div class="container">
    <div id="resume-header" class="row">
      <div class="col-3">
        <img id="profile-picture" src="https://avatars.githubusercontent.com/u/22733769?v=4" alt="">
      </div>
      <div class="col">
        <h1><?php echo $name; ?></h1>
        <h2>PHP Developer</h2>
        <ul>
          <li>Mail: diegoteos@mail.com</li>
          <li>Phone: 1234567890</li>
          <li>LinkedIn: diegoteos</li>
          <li>Twitter: @diegoteos</li>
        </ul>
      </div>
    </div>
    <div class="row">
